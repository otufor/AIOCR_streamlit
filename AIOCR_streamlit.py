...
if uploaded_file is not None:
  ...
  if True: # AIOCR実行
    ...
    for idx, line in enumerate(text_result.lines, start=1):
      ...
      draw.polygon([result_bb1, result_bb2, result_bb3, result_bb4], fill=None, outline='green')
      
      font = ImageFont.truetype(font='./resources/NotoSansJP-Regular.otf', size=16)
      text_w, text_h = draw.textsize(str(idx), font=font)
      result_textbox = line.bounding_box[0], line.bounding_box[1], line.bounding_box[0]+text_w, line.bounding_box[1]+text_h
